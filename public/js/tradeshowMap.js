...
function initMap() {
  ...
  var markers = [
    ...
    // ['SEAUPG, Oklahoma City, OK', 35.441408, -97.540307],
    ...
    // ['APAM, Mt. Pleasant, MI', 43.596119, -84.773506],
  ...
  var infoWindowContent = [
    ...
    //     '<span>SEAUPG 2026</span><br>' +
    //     '<hr>' +
    //     'Oklahoma City, OK<br>' +
    //     'November 17-19, 2026<br>' +
    ...
    [
      '<div class="map-text">' +
        ...
        '<span>TRB 106th Annual Meeting - Booth #724</span><br>' +
        '<hr>' +
        'Washington D.C.<br>' +
        'January 10-14, 2027<br>' +
    ...
    [
      '<div class="map-text">' +
        ...
        '<span>67th Annual PAPA Conference</span><br>' +
        '<hr>' +
        'Hershey, PA<br>' +
        'January 18-20, 2027<br>' +
        '<p><a class="link" href="https://www.pa-asphalt.org/events/all-events/papa-main-events/151-67th-annual-papa-conference-save-the-date" target="_blank"><i class="fab fa-chrome"></i> Visit Website</a></p>' +
        '</div>',
    ],
    ...
    //     '<hr>' +
    //     'Mt. Pleasant, MI<br>' +
    //     'February 24-25, 2027<br>' +
    //     '<p><a class="link" href="https://mms.apa-mi.org//Calendar/moreinfo.php?org_id=APAM&eventid=221921" target="_blank"><i class="fab fa-chrome"></i> Visit Website</a></p>' +
    //     '</div>',
    // ],
    ...
    [
      '<div class="map-text">' +
        ...
        '<span>WAPA 67th Annual Conference</span><br>' +
        '<hr>' +
        'Wisconsin Dells, WI<br>' +
        'December 1-2, 2026<br>' +
        '<p><a class="link" href="https://www.wispave.org/wapas-67th-annual-conference-and-business-meeting" target="_blank"><i class="fab fa-chrome"></i> Visit Website</a></p>' +
        '</div>',
    ],
